...
class InterestKeywordCustomTest extends IntegrationTestSupport {
    ...
    @ParameterizedTest
    void testSearch(String searchWord, String orderBy, String direction, String cursor, String after, int limit, List<String> expectedResults) {
        // given
    ...
    void groupKeywordsByInterest() {
        ...
        // when
        Map<Interest, List<String>> interestListMap = interestKeywordRepository.groupKeywordsByInterest(List.of(savedFirstInterest, savedSecondInterest));
    ...
    void groupKeywordsByInterest_NullException(List<Interest> input) {
        // when
        Map<Interest, List<String>> interestListMap = interestKeywordRepository.groupKeywordsByInterest(input);
